        ...
        <Container className="flex flex-col md:flex-row gap-10 py-10">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-5">
                ...
                <div className="space-y-2 border-t border-b border-gray-200 py-5  ">
                    ...
                    />
                    <p
                        className={`px-4 py-1.5 text-center inline-block font-semibold rounded-lg 
                ...
                <div
                    className="flex flex-wrap items-center justify-between gap-2.5 border-b border-b-gray-200 py-5
                -mt-2"
                >
                    <div className="flex items-center gap-2 text-sm text-black hover:text-shop_light_green hoverEffect">
