    ...
    return (
        <CheckboxPrimitive.Root
            ...
            className={cn(
                ...
                data-[state=checked]:border-shop_light_green focus-visible:border-ring focus-visible:ring-ring/50 
        ...
        >
            <CheckboxPrimitive.Indicator
                ...
                data-[state=checked]:bg-shop_light_green data-[state=checked]:text-white
                "
            >
