...
const ShopByBrands = async () => {
    ...
    rounded-md"
        >
            ...
            <div
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-16 p-2 
            shadow-sm hover:shadow-shop_light_green py-5"
            >
                {extraData?.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="text-sm">
                            <p className="text-darkColor font-bold capitalize">
                                {item?.title}
                            </p>
