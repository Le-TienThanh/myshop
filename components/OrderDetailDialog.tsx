        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="!max-w-4xl max-h-[90vh] overflow-y-scroll">
                ...
                <div className="mt-4">
                    ...
                    {
                        order?.invoice && (
                            <Button className='bg-transparent border text-darkColor/80 mt-2 
                            hover:text-darkColor hover:border-darkColor hover:bg-darkColor/10
                            hoverEffect'>
                                {
                                ...
                                <TableRow key={index}>
                                    <TableCell className='flex items-center gap-2'>
                                        {product?.product?.images && (
                                            <Image src={urlFor(product?.product?.images[0]).url()} alt='productImage' width={50}
                                            height={50} className='border rounded-sm' />
                                        )}
                        ...
                        )}
                        {
                            order?.amountDiscount !== 0 && (
                                <div className='w-full flex items-center justify-between'>
                                    ...
                                    <PriceFormatter amount={(order?.totalPrice as number) + (order?.amountDiscount as number)} 
